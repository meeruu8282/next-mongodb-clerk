...
var seed = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    var mediaDir, _a, demoAuthorID, demoUserID, _b, _c, _d, _e, image1Doc, image2Doc, _f, _g, _h, _j, technologyCategory, newsCategory, financeCategory, designCat, softwareCat, engineeringCat, _k, _l, _m, post1Doc, post2Doc, post3Doc, posts, _o, _p, _q, project1Doc, project2Doc, project3Doc, _r, _s, _t, postsPageID, projectsPageID;
    return __generator(this, function (_u) {
        switch (_u.label) {
            ...
            case 6: return [4 /*yield*/, _g.apply(_f, [_h.concat([
                        _u.sent()
                    ])])];
            case 7:
            ...
            case 13: return [4 /*yield*/, _l.apply(_k, [_m.concat([
                        _u.sent()
                    ])])];
            case 14:
            ...
            case 22:
                ...
                return [4 /*yield*/, payload.create({
                        collection: 'projects',
                        data: JSON.parse(JSON.stringify(__assign(__assign({}, project_1_1.project1), { categories: [designCat.id] })).replace(/{{IMAGE}}/g, image2Doc.id)),
                    })];
            case 23:
                project1Doc = _u.sent();
                return [4 /*yield*/, payload.create({
                        collection: 'projects',
                        data: JSON.parse(JSON.stringify(__assign(__assign({}, project_2_1.project2), { categories: [softwareCat.id] })).replace(/{{IMAGE}}/g, image2Doc.id)),
                    })];
            case 24:
                project2Doc = _u.sent();
                return [4 /*yield*/, payload.create({
                        collection: 'projects',
                        data: JSON.parse(JSON.stringify(__assign(__assign({}, project_3_1.project3), { categories: [engineeringCat.id] })).replace(/{{IMAGE}}/g, image2Doc.id)),
                    })
