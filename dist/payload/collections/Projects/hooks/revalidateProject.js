...
exports.revalidateProject = void 0;
...
var revalidateProject = function (_a) {
    var doc = _a.doc, payload = _a.req.payload;
    if (doc._status === 'published') {
        (0, revalidate_1.revalidate)({ payload: payload, collection: 'projects', slug: doc.slug });
    }
    return doc;
};
exports.revalidateProject = revalidateProject;
