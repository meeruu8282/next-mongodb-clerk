      ...
      <div className="flex justify-center items-center w-screen h-auto flex-col">
        ...
        <div className="relative flex  max-w-[1190px] w-[95%] lg:w-[90%] flex-wrap justify-center lg:justify-between">
          <div className="w-[70%] mt-6 md:mt-12 md:mb-2 mb-20 text-center md:text-left md:w-[90%]">
            <h1 className="text-[Poppins] text-[32px] md:text-[24px] leading-[29px] tracking-[0em] left-0 font-semibold mt-5">
              Why Become a Carelyo Partner?
            </h1>
          </div>
          <HelpCard
            icon={'/helpCardImg.png'}
            header={'Wide Market Potential'}
            paragraph={`provide access to a broad and diverse market. Enhance your visibility among potential healthcase service providers.`}
            link={''}
          />
          <HelpCard
          ...
          <PartnerAdvantage
            ...
            paragraph={
              "Partnering with us opens up a world of advantages, incloding access to a vast network, collaborative opprtunities, enhanced credibility, increased exposure and marketing, technical support and resources, and the opportunity for continuous growth and collaboration. By becoming our partner, you can leverage these advantages to expand your reach, enhance your organization's reputation, and drive positive change in the healthcare industry."
            }
