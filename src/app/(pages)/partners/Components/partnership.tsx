      ...
      <div className='flex flex-col sm:flex-row justify-between items-center gap-3 w-[95%] lg:w-[95%] xl:w-[80%]'>
        <div className='flex flex-col justify-center items-center max-w-[13rem] w-full gap-3'>
          <div className='flex justify-center items-center'>
            <h2 className='font-bold text-[Poppins] text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-greenText'>{number1}</h2>
          </div>
          <div>
        ...
        <div className='flex flex-col justify-center items-center max-w-[13rem] w-full gap-3'>
          <div className='flex justify-center items-center'>
            <h2 className='font-bold text-[Poppins] text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-greenText'>{number2}</h2>
          </div>
          <div>
        ...
        <div className='flex flex-col justify-center items-center max-w-[13rem] w-full gap-3'>
          <div className='flex justify-center items-center'>
            <h2 className='font-bold text-[Poppins] text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-greenText'>{number3}</h2>
          </div>
          <div>
        ...
        <div className='flex flex-col justify-center items-center max-w-[13rem] w-full gap-3'>
          <div className='flex justify-center items-center'>
            <h2 className='font-bold text-[Poppins] text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-greenText'>{number4}</h2>
          </div>
          <div>
