    ...
    <div>
        ...
        <section>
            <div className="container py-12 px-12 flex justify-around mx-auto">
                <button className="bg-[#45AC60] text-white rounded-full text-md font-semibold py-2 px-3 w-24 h-10">For you</button>
                <button className="bg-none text-black rounded-full text-md font-semibold py-2 px-3 w-fit h-10">Health and Wellness</button>
                <button className="bg-none text-black rounded-full text-md font-semibold py-1 px-2 w-fit h-10">Healthy Living</button>
                <button className="bg-none text-black rounded-full text-md font-semibold py-1 px-2 w-fit h-10">Medical Innovations</button>
                <button className="bg-none text-black rounded-full text-md font-semibold py-1 px-2 w-fit h-10">Patient Stories</button>
            </div>
