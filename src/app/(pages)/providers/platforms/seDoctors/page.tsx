  ...
  return (
    ...
    <div className="HideMobileMode h-screen sm:block hidden">
      ...
      header={"Here are the key benefits you can enjoy"}
       text={"Joining Carelyo as a self-employed doctor comes with numerous advantages that can enhance your practice and provide a seamless experience for both you and your patients."} 
