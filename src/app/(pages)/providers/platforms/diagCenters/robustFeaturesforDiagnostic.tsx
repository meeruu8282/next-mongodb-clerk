      ...
      <div className="relative flex flex-col items-center justify-between max-w-[80vw] w-full rounded-[25px] mt-28 px-4 py-12">
        <div className="flex justify-center rounded-[25px] bg-neutral-50 w-full">
          <div className="flex flex-col md:flex-row justify-between items-center w-full mt-12">
            <h1 className="text-[poppins] text-2xl font-semibold leading-10 tracking-normal text-center md:text-left">
              {header}
            </h1>
        ...
        <div className="flex flex-col md:flex-row justify-between gap-16 w-full mt-12">
