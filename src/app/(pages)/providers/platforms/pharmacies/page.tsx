...
export default function Pharmacies() {
  return (
    <div className="">
      ...
      <KeyPoints
        header={'Here are the key points you can expect from Carelyo'}
        text={
          'With Carelyo, we provide a comprehensive solution to streamline your pharmacy operations and improve patient care.'
        }
      ...
      <WhychooseCarelyo
        ...
        paragraph={
          'Join Carelyo and experience the transformative power of our platform in streamlining pharmacy operations, enhancing patient care, and maximizing efficiency. Together, we can create a more seamless and customer-centric pharmacy experience that benefits both healthcare providers and patients alike.'
        }
