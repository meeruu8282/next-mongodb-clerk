...
// Import data
import { cardDescription } from '../../pricing/freeData';
...
const PricingCards: React.FC<CardsProps> = ({
    ...
    <>
      <div className="flex justify-center">
        ...
        {combinedData.map((data) => (
          <div className={`${style.priceFreeCard} min-w-[17.5rem] max-w-[29rem]
  ...
  <h1
    className={`leading-tight font-semibold text-red-500 line-through ${
