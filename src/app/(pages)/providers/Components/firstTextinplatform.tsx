...
interface FirstTextinplatformTamplateProps {
  ...
  return (
    // first header text thats in all platform components
    <div className="w-full mb-12 flex justify-center items-center flex-col gap-6">
      ...
      <div className="w-[90%] opacity-[50%] md:max-w-[70%] lg:max-w-[60%]
      xl:max-w-[53%] mx-auto">
