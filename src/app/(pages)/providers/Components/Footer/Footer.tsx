...
const Footer = () => {
  return (
    <>
            <div className="bg-gray-100 min-h-min top-[5978px] flex flex-cool mt-10 ">
          <div className="flex justify-around items-center   md:items-center md:flex-row flex-col mt-5 w-screen h-[270px] p-[0px] pr-[88px] pl-[88px]  ">
            {/* Lägg till flex här */}
