...
interface JoinCarelyoHeaderProps {
  ...
  const JoinCarelyheader: React.FC<JoinCarelyoHeaderProps> = ({ 
    ...
    if (userType === 'Self-Employed Doctors') {
      ...
      headerSubtitle = "With our innovative features and comprehensive support, we aim to empower your practice and enhance patient care.";
