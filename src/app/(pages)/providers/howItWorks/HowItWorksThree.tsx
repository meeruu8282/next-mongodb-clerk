  ...
  return (
    ...
    <div className="flex w-full flex-row justify-start items-center font-normal pb-3 gap-6">
      <div className="flex justify-center items-center">
        <h2 className="text-[Poppins] text-5xl font-semibold text-[#45AC60] leading-10">{hashtagNumber}</h2>
      </div>
      <div className="flex justify-center items-center text-center">
        <h2 className="text-[Poppins] text-3xl font-normal text-[#000000] leading-10" >{header}</h2>
      </div>
    </div>
    ...
    <div className="flex w-full flex-col justify-center items-center font-normal bg-gradient-to-br from-[#45AC60] to-[#7EDC97] rounded-3xl text-[Poppins]">
