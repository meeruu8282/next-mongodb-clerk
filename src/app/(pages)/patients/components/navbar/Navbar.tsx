      ...
      >
        <div className="flex gap-3">
          <div className="flex w-[418px] h-[24px] justify-between text-[Poppins] font-normal z-[1000px]">
            <Link href="/patients/howitworks" className="w-[105px] h-[22px] text-base">
              How it works
            </Link>
            ...
            <Link href="/patients/blog" className="text-black gap-[5px]">
              <nav className="flex text-1xl h-[22px] text-base">Blog</nav>
            </Link>

            <Link href="/patients/help" className="text-black gap-[5px]">
